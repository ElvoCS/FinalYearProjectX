...
function Login() {
  ...
  return (
    <div className="login">
      <Link to="/home">
        <img className="login__logo" src="https://i.imgur.com/HXLpCJc.png" />
      </Link>
      <div className="login__container">
        ...
        <p>By signing-in you agree to BrainTrains terms and conditions.</p>
        <button onClick={register} className="login__registerButton">
          Create your BrainTrain Account
        </button>
      </div>
    </div>
  );
